...
class PieceRemovalTestCase(unittest.TestCase):
    ...
    def test_single_piece(self):
        ...
        next_state = gojax.next_states(state, state_index.action_2d_to_indicator([(0, 1)], state))
    ...
    def test_two_connected_pieces(self):
        state_str = """
                    ...
                    """
        state = serialize.decode_states(state_str, gojax.BLACKS_TURN)
        next_state = gojax.next_states(state, state_index.action_2d_to_indicator([(0, 2)], state))
